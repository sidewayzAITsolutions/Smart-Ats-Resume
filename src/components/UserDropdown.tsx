...
className=“flex items-center space-x-2 px-4 py-2 bg-gray-800 hover:bg-gray-700 text-white rounded-lg transition-all duration-200 border border-teal-400 hover:border-purple-600”
aria-haspopup=“true”
